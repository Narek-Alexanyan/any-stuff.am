...
function DarkModeToggle() {
  ...
  return (
    <button
      type="button"
      onClick={toggle}
      className="flex items-center justify-center space-x-2 w-full focus:outline-none group"
    >
      ...
      <div className="relative rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-theme-500">
        <div className="w-6 h-3.5 transition bg-gray-500 rounded-full shadow-md outline-none" />
        <div
